...
async function analyzeSuggestion(suggestionText: string): Promise<SuggestionAnalysis> {
    ...
    const response = await ai.models.generateContent({
        ...
        contents: `Analisa a seguinte sugestão para um manifesto de IA: "${suggestionText}"`, // Corrected: escaped inner quotes
        config: {
...
Fact1: [Escreve um facto conciso sobre um evento ou desenvolvimento que suporte o princípio, incluindo a organização ou fonte (ex: 'A União Europeia implementou o AI Act para criar regras claras... ').]

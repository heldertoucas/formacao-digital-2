...
import MicrosoftCopilotCoursePage2 from './pages/MicrosoftCopilotCoursePage2';
...
const App = () => {
    ...
    return (
        <div className={theme} key={route}>
            <AppLayout route={route} navigateTo={navigateTo}>
                <AppRouter route={route} pages={pages} navigateTo={navigateTo} />
            </AppLayout>
        </div>
    );
};
